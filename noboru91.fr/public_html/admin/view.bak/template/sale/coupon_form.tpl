...
<div id="content">
  ...
  <div class="box">
<div class="heading">
      <h1><img alt="" src="view/image/customer.png"> Bon de réduction</h1>
      <div class="buttons"><a class="btn btn-success" onclick="$('#form').submit();">Sauvegarder</a><a class="btn btn-danger" href="http://guenki.fr/J_guenki/index.php?route=sale/coupon&amp;token=150b63cd7763e22f22899320e9f4d7b5&amp;sort=date_start&amp;order=DESC">Annuler</a></div>
    </div>
    <div class="content">
