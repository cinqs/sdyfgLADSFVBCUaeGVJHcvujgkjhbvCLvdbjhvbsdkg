...
<div id="content" class="span10">
  ...
  <?php } ?>      
      ...
      <div class="box">
    <div class="heading">
      <div class="buttons"><a onclick="$('form').attr('action', '<?php echo $approve; ?>'); $('form').submit();" class="btn btn-success"><?php echo $button_approve; ?></a><a <a onclick="$('form').attr('action', '<?php echo $delete; ?>'); $('form').submit();"  class="btn btn-danger"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
