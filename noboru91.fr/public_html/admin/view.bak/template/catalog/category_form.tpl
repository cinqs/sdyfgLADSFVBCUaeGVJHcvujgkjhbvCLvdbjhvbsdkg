          ...
          <div id="language<?php echo $language['language_id']; ?>">
            ...
            <tr>
              ...
              <td><input type="text" name="sort_order" value="<?php echo $sort_order; ?>" size="1" /></td>
               ...
               <tr>
                <td><?php echo $entry_meal;?></td>
                <td><?php if ($meal) { ?>
                  <input type="checkbox" name="meal" value="1" checked="checked" />
                  <?php } else { ?>
...
<!-- 	            <tr>
              ...
              <tr>
              <td>MIDI/SOIR Disponible :</td>
              <td><select name="temp">
                  <option value="3" <?php if($temp == 3){echo "selected='selected'";}?> >TOUT</option>
                  <option value="1" <?php if($temp == 1) echo "selected='selected'";?>>MIDI</option>
                  <option value="2" <?php if($temp == 2) echo "selected='selected'";?>>SOIR</option>
                  </select>
               </td>
            </tr>
            </table>
