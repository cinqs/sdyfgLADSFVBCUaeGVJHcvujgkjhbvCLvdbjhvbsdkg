		...
		<section class="index-container">
		    ...
		    <?php if ($deviceUse == "desktop") {?>
			    <div id="myCarousel" class="carousel slide" data-ride="carousel">
			      ...
			      <div class="carousel-inner" role="listbox">
			      	<div class="item active" style="background-image: url(image/noboruf2.jpg)"></div>
			        <div class="item" style="background-image: url(image/noboruf3.jpg)"></div>
			        <div class="item" style="background-image: url(image/noboruf1.jpg)"></div>
			      </div>
			...
			<?php }elseif ($deviceUse == "mobile") {?>
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
			      ...
			      <div class="carousel-inner" role="listbox">
			        <div class="item active" style="background-image: url(image/mobile/noboru.jpg)"></div>
			        <div class="item" style="background-image: url(image/mobile/noboru2.jpg)"></div>
			      </div>
			      <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev">
			        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
			        <span class="sr-only">Previous</span>
