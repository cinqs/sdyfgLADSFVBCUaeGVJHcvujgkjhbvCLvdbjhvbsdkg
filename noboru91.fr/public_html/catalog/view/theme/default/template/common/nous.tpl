        ...
        <div class="nousRight"><!--
          ...
          <div class="content wow animated fadeInRight">
            ...
            <div class="box1 color-gray ">
              <h3 class="color-yellow ">Livraison  gratuite à partir de 20€( à domicile et au bureau)</h3>
            </div>
            <div class="box2">
              <p class="p1">
                <span class="lb">- À Partir de 25€</span>
                <span>Une canette (33cl) offerte</span>
              </p>
              <p class="p1">
                <span class="lb">- À Partir de 30€</span>
                <span>Un nougat chinois offerte</span>
              </p>
              <p class="p1">
                <span class="lb">- À Partir de 40€</span>
                <span>une bière offerte</span>
              </p>
            </div>
            <div class="box1 color-grey">
              <h3 class="color-yellow">Buffet À Volonté À La Carte</h3>
            </div>
            <div class="box2">
              <p class="p1">
            ...
            <div class="box1 color-grey">
              <h3 class="color-yellow">Les zones de LIVRAISON:</h3>
              <h5 class="color-grey">UNIQUEMENT LE SOIR SAUF LES BONDOUFLOIS</h5>
              <h6 class="color-grey"><i class="fa fa-exclamation-circle"></i>&nbsp;Nos livreurs n'ont pas plus de 15€ en monnaie, pensez à préparer l'appoint.</h6>
            </div>
            <div class="box2">
                  <ul class="inline_block">
                    <li><i class="fa fa-map-marker"></i>&nbsp;Bondoufle&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Vert-le-Grand&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Vert-le-Petit&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Lisses&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Courcouronne&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Sainte-Geneviève-des-Bois&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Fleury-Mérogis&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Ris-Orangis&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Le Plessis-Pâté&nbsp;</li>
                    <li><i class="fa fa-map-marker"></i>&nbsp;Brétigny sur Orge&nbsp;</li>
                  </ul>
            </div>
          </div>
        </div>
  ...
  <?php }else{?>
        <div class="row" id="nousMobile">
          ...
          <div class="content wow animated fadeInRight">
            ...
            <div class="box1 color-gray ">
              <h3 class="color-yellow ">Livraison  gratuite à partir de 20€</h3>
            </div>
            <div class="box2">
              <p class="p1">
                <span class="lb">- À Partir de 25€</span>
              ...
              <p class="p1">
                <span class="lb">- À Partir de 30€</span>
                <span>un nougat chinois offert</span>
              </p>
              <p class="p1">
                <span class="lb">- À Partir de 40€</span>
                <span>une bière offerte</span>
