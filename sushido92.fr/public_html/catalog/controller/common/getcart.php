<?php 
class ControllerCommonGetcart extends Controller {
	private $error = array();
	...
	public function index() {
    	...
    	//print json_encode($this->data['products']);
    	if ($_POST['query'] == 'product') {
    		if (isset($this->data['products'])) {
	    		print json_encode($this->data['products']);
	    	}else{
	    		$data_result[]= $data_return = "noresult";
	    		print json_encode($data_result);
	    	}
    	}else if ($_POST['query'] == 'total') {
    		print json_encode($this->data['totals']);
    	}
  	}
