...
<?php } ?>
  ...
  <?php } ?>
								 	...
								 	<div class="col-sm-6">
										<?php foreach ($totals as $total) {?>
											<h3>
												...
												<span class='money'><?php echo $total['text'];?></span>
											</h3>
										<?php }?>
								 	</div>
								 </div>
								...
								?>
								<?php if ($total_money < $limit_total) {?>
									<div class="cart_buttons">
										<p style="color:red;font-weight:700">Livraison gratuite à partir de <?php echo $limit_total;?>€ </p>
