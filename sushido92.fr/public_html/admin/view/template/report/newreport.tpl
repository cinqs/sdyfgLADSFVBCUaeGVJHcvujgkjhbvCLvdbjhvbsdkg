...
//--></script>
  ...
  <div class="newreport_header">
    ...
    <h2><i class="icon icon-red icon-sent"></i>
           SushiDo           :: <?php echo date("Y-m-d"); ?>   </h2>         
  </div>
      ...
      <table class="list">
        ...
        <tbody>
         <?php if ($customers) { ?>
          ...
          <?php
            //echo "<pre>";print_r($customer["result"]);echo "</pre>";
          ?>
           <tr class="list">                       
            ...
            <td class="left"><?php echo $customer['date_modified']; ?></td>
            <td class="left" style="font-size:14px;color:blue" id="<?php echo $customer['status']; ?>"><?php echo $customer['status']; ?></td>
            <td class="left"><?php if (intval($customer['liv'])) {
              echo "<span style='color:red'>EMPORTER<br>";
              echo $customer['realtime']."</span>";
            }else{
              echo "LIVRAISON <br>";echo $customer['realtime'];
              } ?></td>
            <td class="left"><?php //echo $customer['customer']; ?></td>
