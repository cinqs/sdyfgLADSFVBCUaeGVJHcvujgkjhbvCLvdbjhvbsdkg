...
<div id="content" class="span10">
  ...
  <?php } ?>      
      ...
      <div class="box">
      <div class="heading">
      <div class="buttons"><a onclick="$('#form').submit();" class="btn btn-success"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="btn btn-danger"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <div id="tabs" class="htabs"><a class="selected" style="display: inline;" href="#tab-general">Général</a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-mail"><?php echo $tab_mail; ?></a></div>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div style="display: block;" id="tab-general">
          <table class="form">
            ...
            <tr>
              <td><span class="required">*</span> Nom de la boutique :</td>
              <td><input name="config_name" value="<?php echo $config_name; ?>" size="40" type="text">
                </td>
            </tr>
            <tr>
              <td><span class="required">*</span> Propriétaire de la boutique :</td>
              <td><input name="config_owner" value="<?php echo $config_owner; ?>" size="40" type="text">
                </td>
            </tr>
            <tr>
              <td><span class="required">*</span> Adresse :</td>
              <td><textarea name="config_address" cols="40" rows="5"><?php echo $config_address; ?></textarea>
                </td>
            </tr>
            <tr>
              <td><span class="required">*</span> Courriel :</td>
              <td><input name="config_email" value="<?php echo $config_email; ?>" size="40" type="text">
                </td>
            </tr>
            <tr>
              <td><span class="required">*</span> Téléphone :</td>
              <td><input name="config_telephone" value="<?php echo $config_telephone; ?>" type="text">
                </td>
            </tr>
            <tr>
              <td>Fax :</td>
              <td><input name="config_fax" type="text"></td>
            </tr>
            <tr>
              <td>Offre de Bienvenue :</td>
              <td><input name="config_bienvenue_credit" value="<?php echo $config_bienvenue_credit; ?>" type="text"> €</td>
            </tr>
            <tr>
              <td>LUNDI : </td>
              <td><input name="config_horaire_AM_1" value="<?php echo $config_horaire_AM_1; ?>" type="text">  ( Horaire Midi )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_horaire_PM_1" value="<?php echo $config_horaire_PM_1; ?>" type="text">  ( Horaire Soir )</td>
            </tr>
            <tr>
              <td>MARDI : </td>
              <td><input name="config_horaire_AM_2" value="<?php echo $config_horaire_AM_2; ?>" type="text">  ( Horaire Midi )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_horaire_PM_2" value="<?php echo $config_horaire_PM_2; ?>" type="text">  ( Horaire Soir )</td>
            </tr>
            <tr>
              <td>MECREDI : </td>
              <td><input name="config_horaire_AM_3" value="<?php echo $config_horaire_AM_3; ?>" type="text">  ( Horaire Midi )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_horaire_PM_3" value="<?php echo $config_horaire_PM_3; ?>" type="text">  ( Horaire Soir )</td>
            </tr>
            <tr>
              <td>JEUDI : </td>
              <td><input name="config_horaire_AM_4" value="<?php echo $config_horaire_AM_4; ?>" type="text">  ( Horaire Midi )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_horaire_PM_4" value="<?php echo $config_horaire_PM_4; ?>" type="text">  ( Horaire Soir )</td>
            </tr>
            <tr>
              <td>VENDREDI : </td>
              <td><input name="config_horaire_AM_5" value="<?php echo $config_horaire_AM_5; ?>" type="text">  ( Horaire Midi )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_horaire_PM_5" value="<?php echo $config_horaire_PM_5; ?>" type="text">  ( Horaire Soir )</td>
            </tr>
            <tr>
              <td>SAMEDI : </td>
              <td><input name="config_horaire_AM_6" value="<?php echo $config_horaire_AM_6; ?>" type="text">  ( Horaire Midi )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_horaire_PM_6" value="<?php echo $config_horaire_PM_6; ?>" type="text">  ( Horaire Soir )</td>
            </tr>
            <tr>
              <td>DIMANCHE : </td>
              <td><input name="config_horaire_AM_0" value="<?php echo $config_horaire_AM_0; ?>" type="text">  ( Horaire Midi )&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_horaire_PM_0" value="<?php echo $config_horaire_PM_0; ?>" type="text">  ( Horaire Soir )</td>
            </tr>
             <tr>
              <td>JiuSong: </td>
              <td>
              		<div>title：<input size="40" name="config_promotion_1" value="<?php echo $config_promotion_1; ?>" type="text"> money&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_money_1" value="<?php echo $config_money_1; ?>" type="text"></div>
              		<div>title：<input size="40" name="config_promotion_2" value="<?php echo $config_promotion_2; ?>" type="text"> money&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_money_2" value="<?php echo $config_money_2; ?>" type="text"></div>
              		<div>title：<input size="40" name="config_promotion_3" value="<?php echo $config_promotion_3; ?>" type="text"> money&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="config_money_3" value="<?php echo $config_money_3; ?>" type="text"></div>
              </td>
            </tr>
            <tr>
              <td>Maintenance :<br><span class="help">Empêche les 
clients de naviguer dans votre boutique. Ils verront à la place un 
message de maintenance. Par contre dans l’administration, vous ne verrez
 pas de changement.</span></td>
              <td>
                <textarea name="config_text_maintenance" cols="40" rows="5"><?php echo $config_text_maintenance; ?></textarea>
