...
<div id="content" class="span10">
  ...
  <?php } ?>      
      ...
      <div class="box">
    <div class="heading">
      <div class="buttons"><a href="<?php echo $insert; ?>" class="btn btn-info"><?php echo $button_insert; ?></a><a onClick="$('#form').submit();" class="btn btn-danger"><?php echo $button_delete; ?></a></div>
    </div>
    <div class="content">
