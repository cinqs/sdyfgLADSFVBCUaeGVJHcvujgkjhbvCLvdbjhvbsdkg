	...
	public function index() {  
		...
		foreach ($results as $result) {
			...
			switch ($result['status']) {
					case '-30mins':
						$souhait = date("d/m/Y H:i:s", strtotime(date("Y/m/d H:i:s", strtotime($result['date_modified']))."+30 minutes"));
						break;

					case '45-60mins':
						$souhait = date("d/m/Y H:i:s", strtotime(date("Y/m/d H:i:s", strtotime($result['date_modified']))."+60 minutes"));
						break;

					case '60-75mins':
						$souhait = date("d/m/Y H:i:s", strtotime(date("Y/m/d H:i:s", strtotime($result['date_modified']))."+75 minutes"));
						break;

					case '75-90mins':
						$souhait = date("d/m/Y H:i:s", strtotime(date("Y/m/d H:i:s", strtotime($result['date_modified']))."+90 minutes"));
						break;

					case '90+mins':
						$souhait = date("d/m/Y H:i:s", strtotime(date("Y/m/d H:i:s", strtotime($result['date_modified']))."+120 minutes"));
						break;
