<div class="row">
  ...
  Batiment<br />
  <input type="text" name="batiment" value="" class="large-field" />
  <br />
  <br />
  Escalier<br />
  <input type="text" name="escalier" value="" class="large-field" />
  <br />
  <br />
  Interphone<br />
  <input type="text" name="interphone" value="" class="large-field" />
  <br />
  <br />
  Ascenceur<br />
  <input type="text" name="ascenceur" value="" class="large-field" />
  <br />
  <br />
  Digicode1<br />
  <input type="text" name="digicode1" value="" class="large-field" />
  <br />
  <br />
  Digicode2<br />
  <input type="text" name="digicode2" value="" class="large-field" />
  <br />
  <br />
  Etage<br />
  <input type="text" name="etage" value="" class="large-field" />
  <br />
  <br />
  Porte<br />
  <input type="text" name="porte" value="" class="large-field" />
  <br />
  <br />
...
$('#payment-address select[name="zone_id"]').bind('change', function(){
  var valuePC = this.value;
  $('#payment-address input[name="postcode"]').val(valuePC);
});
