	...
	<div id="fixedCart">
		...
		<div class="total-list-box">
				...
				<table class='cart_class'>
					...
					<tr id="number_change">
						<td colspan="2">Emporter?</td>
						<td colspan="2" id="isEmporter">
							<?php 
								if ($isEmporter) {
									echo "<span value='true' onClick='setEmporter(0)'><i class='fa fa-toggle-on'></i></span>";
								}else{
									echo "<span value='false' onClick='setEmporter(1)'><i class='fa fa-toggle-off'></i></span>";
								}
							?>
						</td>
					</tr>
					<tr class="tr_special">
						...
						<td>
							<input type="number" class="update-cart input-small form-control" name="quantity[240]" id="240" value="<?php 
						...
						<td id="bagu_id">
							<span class="minusCart" onclick="minusCart(240,<?=$p_de_bagu_qty?>)" name="240" value="<?=$p_de_bagu_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
							<span ><?=$p_de_bagu_qty?></span>&nbsp;&nbsp;
							<span class="plusCart" onclick="plusCart(240,<?=$p_de_bagu_qty?>)" name="240" value="<?=$p_de_bagu_qty?>"><i class="fa fa-plus"></i></span>
						</td>-->
						<td id="bagu_id">
							<span onclick="updateToCart(240,<?php 
								if ($p_de_bagu_qty == 0) {
									echo 1;
								}else{
									echo 0;
						...
						<td><div class="delete_cart_menu" onclick="deleteCart(240)" name="240"><i class="fa fa-trash-o"></i></div></td>
					</tr>
					<tr class="tr_special">
						<td>Sauce Sucre</td>
						<td class="opacity0">Graduit</td><!--
						<td>
							<input type="number" class="update-cart input-small form-control" name="quantity[238]" id="238" value="<?php
							if (isset($sucre_qty)) {
								echo $sucre_qty;
							}else{
								echo 0;
						...
						<td id="sucre_id">
							<span class="minusCart" onclick="minusCart(238,<?=$sucre_qty?>)" name="238" value="<?=$sucre_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
							<span ><?=$sucre_qty?></span>&nbsp;&nbsp;
							<span class="plusCart" onclick="plusCart(238,<?=$sucre_qty?>)" name="238" value="<?=$sucre_qty?>"><i class="fa fa-plus"></i></span>
						</td>-->
						<td id="sucre_id">
							<span onclick="updateToCart(238,<?php 
								if ($sucre_qty == 0) {
									echo 1;
								}else{
									echo 0;
						...
						<td><div class="delete_cart_menu" onclick="minusCart(238)" name="238"><i class="fa fa-trash-o"></i></div></td>
					</tr>
					<tr class="tr_special">
						<td>Sauce Sale</td>
						<td class="opacity0">Graduit</td><!--
						<td>
							<input type="number" class="update-cart input-small form-control" name="quantity[239]" id="239" value="<?php
							if (isset($sale_qty)) {
								echo $sale_qty;
							}else{
								echo 0;
						...
						<td id="sale_id">
							<span class="minusCart" onclick="minusCart(239,<?=$sale_qty?>)" name="239" value="<?=$sale_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
							<span ><?=$sale_qty?></span>&nbsp;&nbsp;
							<span class="plusCart" onclick="plusCart(239,<?=$sale_qty?>)" name="239" value="<?=$sale_qty?>"><i class="fa fa-plus"></i></span>
						</td>-->
						<td id="sale_id">
							<span onclick="updateToCart(239,<?php 
								if ($sale_qty == 0) {
									echo 1;
								}else{
									echo 0;
						...
						<td><div class="delete_cart_menu" onclick="deleteCart(239)" name="239"><i class="fa fa-trash-o"></i></div></td>
					</tr>
					...
					<tr class="tr_special">
						...
						<td class="opacity0">Graduit</td><!--
						<td>
							<input type="number" class="update-cart input-small form-control" name="quantity[674]" id="674" value="<?php
							if (isset($wasabi_qty)) {
								echo $wasabi_qty;
							}else{
								echo 0;
						...
						<td id="was_id">
							<span class="minusCart" onclick="minusCart(674,<?=$wasabi_qty?>)" name="674" value="<?=$wasabi_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
							<span ><?=$wasabi_qty?></span>&nbsp;&nbsp;
							<span class="plusCart" onclick="plusCart(674,<?=$wasabi_qty?>)" name="674" value="<?=$wasabi_qty?>"><i class="fa fa-plus"></i></span>
						</td>-->
						<td id="was_id">
							<span onclick="updateToCart(674,<?php 
								if ($wasabi_qty == 0) {
									echo 1;
								}else{
									echo 0;
						...
						<td><div class="delete_cart_menu" onclick="deleteCart(674)" name="674"><i class="fa fa-trash-o"></i></div></td>
					</tr><!--
					<tr>
				...
				<div class="row" style="float:right;text-align:right">
					<div class="col-md-4 font_big"><?=$totals[0]['title']?></div>
					<div class="col-md-8 font_big" id="money_in_total"><?php echo $totals[0]['text'];?></div>
				</div>
				<?php if ($totals[0]['text'] != $totals[1]['text']) {?>
					<br>
					<div class="row" style="float:right;text-align:right">
						<div class="col-md-4 font_big"><?=$totals[1]['title']?></div>
						<div class="col-md-8 font_big"><?php echo $totals[1]['text'];?></div>
					</div>
				<?php }?>-->
				<?php foreach ($totals as $total) {?>
					<div class="row cartTotal">
						<div class="col-md-4 font_big"><?=$total['title']?></div>
						<div class="col-md-8 font_big"><?php echo $total['text'];?></div>
					</div>
				<?php }?>
						...
						<div class="row" id="cate_row_restr_width_2">
							<div class="navbar-header">
								...
								<a href="http://<?php echo $_SERVER['SERVER_NAME'];?>" class="navbar-brand">
									<span class="logo"><img class='auto_width' src="http://<?php echo $_SERVER['SERVER_NAME'];?>/image/wasabi_new_logo.png" alt=""></span>
								</a>
								<!-- login-div -->
				...
				<div class="row" id="cate_row_restr_width">
					...
					<div class="carteRight col-md-8">
						<div class="carte-nav animated fadeInUp" id="sub_menu_div">
							...
							?>
						</div><h3 style="color:#1b97c5;text-indent:7%">
						<?php 
							if (isset($child_cat_id)) {
								foreach ($categories as $category) {
									if ($category["category_id"] == $parent_cat_id) {
