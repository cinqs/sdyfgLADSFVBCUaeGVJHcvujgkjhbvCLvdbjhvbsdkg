...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <div class="buttons"><a onclick="$('#form').submit();" class="btn btn-info"><?php echo $button_save; ?></a><a href="<?php echo $cancel; ?>" class="btn btn-danger"><?php echo $button_cancel; ?></a></div>
    </div>
    <div class="content">
      <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><!--<a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a>  --><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-setmeal"><?php echo $tab_attribute; ?></a><a href="#tab-meal"><?php echo $tab_attribute; ?></a><!-- <a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a> --></div>
        ...
        <div id="tab-general">
          ...
          <div id="language<?php echo $language['language_id']; ?>">
            ...
            <tr>
              ...
              <td><input type="text" value="" name="category" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true"/></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
          ...
          <table id="setmeal" class="list">
            ...
            <?php $setmeal_row = 1; 
                ...
                //print_r($product_meals);die;

            ?>
            <?php foreach ($setmeals as $setmeal) { ?>
            <tbody id="setmeal-row<?php echo $setmeal_row; ?>">
              <tr>
                <td class="left" ><input type="text" name="setmeal_meal[<?php echo $setmeal_row; ?>][id]" value="<?php echo $setmeal['meal_id']; ?>" />
                </td>
                <td class="left"><a onclick="$('#setmeal-row<?php echo $setmeal_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $setmeal_row++; ?>
            <?php } ?>
            <tfoot>
              <tr>
                <td></td>
                <td class="left"><a onclick="addSetMeal();" class="button"><?php echo $button_add_attribute; ?></a></td>
              </tr>
            </tfoot>
          </table>
        </div>
          ...
          <table id="attribute" class="list">
            ...
            ?>
            <?php foreach ($product_meals as $product_meal) { ?>
            <tbody id="meal-row<?php echo $meal_row; ?>">
              <tr>
                <td class="left" ><input type="text" style="margin-top:8px;" name="product_meal[<?php echo $meal_row; ?>][name]" value="<?php echo $product_meal['name']; ?>" />
                  <input type="hidden" name="product_meal[<?php echo $meal_row; ?>][meal_id]" value="<?php echo $product_meal['meal_id']; ?>" />

                  <?php if($setmeals){
                   foreach ($setmeals as $key => $value) { ?>
                    <label class="checkbox-inline"><input type="checkbox" <?php if(in_array($value['meal_id'],$product_meal['setmeal'])){echo "checked='checked'";}?> name="product_meal[<?php echo $meal_row; ?>][setmeal][][setmeal_id]" value="<?php echo $value['meal_id']?>"> <?php echo $value['meal_id']?></label>
                    
                  <?php }}?>
                  </td>
                <td class="left"><a onclick="$('#meal-row<?php echo $meal_row; ?>').remove();" class="button"><?php echo $button_remove; ?></a></td>
              </tr>
            </tbody>
            <?php $meal_row++; ?>
            <?php } ?>
...
//--></script> 
<script type="text/javascript"><!--
var meal_row = <?php echo $meal_row; ?>;

function addAttribute() {
	html  = '<tbody id="meal-row' + meal_row + '">';
    html += '  <tr>';
	html += '    <td class="left"><input type="text" name="product_meal[' + meal_row + '][name]" value="" /><input type="hidden" name="product_meal[' + meal_row + '][meal_id]" value="" /></td>';
	html += '    <td class="left"><a onclick="$(\'#meal-row' + meal_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';	
    html += '</tbody>';
	
	$('#attribute tfoot').before(html);
	
	attributeautocomplete(meal_row);
	
	meal_row++;
}

function attributeautocomplete(meal_row) {
	$('input[name=\'product_meal[' + meal_row + '][name]\']').catcomplete({
		delay: 500,
		source: function(request, response) {
			$.ajax({
		...
		select: function(event, ui) {
			$('input[name=\'product_meal[' + meal_row + '][name]\']').attr('value', ui.item.label);
			$('input[name=\'product_meal[' + meal_row + '][meal_id]\']').attr('value', ui.item.value);
...
var setmeal_row = <?php echo $setmeal_row;?>;
function addSetMeal() {
    html  = '<tbody id="setmeal-row' + setmeal_row + '">';
    html += '  <tr>';
    html += '    <td class="left"><input type="text" name="setmeal_meal[' + setmeal_row + '][id]" value="'+setmeal_row+'" /></td>';
    html += '    <td class="left"><a onclick="$(\'#setmeal-row' + setmeal_row + '\').remove();" class="button"><?php echo $button_remove; ?></a></td>';
    html += '  </tr>';  
    html += '</tbody>';
  
  $('#setmeal tfoot').before(html);
