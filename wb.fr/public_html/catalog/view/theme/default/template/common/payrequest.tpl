...
if(true){
	...
	if(true){
		...
		$parm     = "$parm normal_return_url=http://wasabisushi.fr/index.php?route=common/payment";
		$parm     = "$parm cancel_return_url=http://wasabisushi.fr/index.php?route=common/payment";
		// By NeO-NeC XYZ MULTIMEDIA
		$parm     = "$parm automatic_response_url=http://wasabisushi.fr/index.php?route=common/payment";
		// By NeO-NeC XYZ MULTIMEDIA
