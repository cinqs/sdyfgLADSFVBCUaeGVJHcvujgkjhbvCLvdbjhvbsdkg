		...
		<section class="index-container">
			...
			<div class="index-banner">
				<div class="flexslider">
					<ul class="slides">
						<li>
							<img src="http://<?php echo $_SERVER["SERVER_NAME"];?>/image/1.jpg" alt="Slide 1" class="front-img">
							<div class="slider-caption">
								<div class="logo-box wow animated bounceInUp">
									<div class="img"><!--
										<img src="http://<?php echo $_SERVER["SERVER_NAME"]?>/catalog/view/theme/default/image/new/logo2.png" alt="">--></div>
									<!--<div class="wz">
										<h3 class="color-white">or maybe in</h3>
										<h1>
											<span class="color-red">DREAM</span>
											<span class="color-blue">SUSHI</span>
										</h1>
									</div>-->
								</div>
								<a href="<?php echo $categories[1]['href'];?>" class="index-btn animated  shake infinite" data-wow-delay="1s">
									<img src="http://<?php echo $_SERVER["SERVER_NAME"]?>/catalog/view/theme/default/image/new/index-btn.png" alt=""></a>
							</div>
						</li>
						<li>
							<img src="http://<?php echo $_SERVER["SERVER_NAME"];?>/image/2.jpg" alt="Slide 2" class="front-img">
							<div class="slider-caption">
						...
						<li>
							<img src="http://<?php echo $_SERVER["SERVER_NAME"];?>/image/3.jpg" alt="Slide 3" class="front-img">
							<div class="slider-caption">
								<a href="<?php echo $categories[1]['href'];?>" class="index-btn animated  shake" data-wow-delay="1s">
									<img src="http://<?php echo $_SERVER["SERVER_NAME"]?>/catalog/view/theme/default/image/new/index-btn.png" alt=""></a>
							</div>
