...
class ControllerShippingPickup extends Controller {
	...
	public function index() {   
		...
		$this->data['entry_remise'] = $this->language->get('entry_remise');
		$this->data['entry_remise_limite'] = $this->language->get('entry_remise_limite');
		...
		if (isset($this->request->post['pickup_remise'])) {
			$this->data['pickup_remise'] = $this->request->post['pickup_remise'];
		} else {
			$this->data['pickup_remise'] = $this->config->get('pickup_remise');
		}

		if (isset($this->request->post['pickup_remise_limite'])) {
			$this->data['pickup_remise_limite'] = $this->request->post['pickup_remise_limite'];
		} else {
			$this->data['pickup_remise_limite'] = $this->config->get('pickup_remise_limite');
		}
