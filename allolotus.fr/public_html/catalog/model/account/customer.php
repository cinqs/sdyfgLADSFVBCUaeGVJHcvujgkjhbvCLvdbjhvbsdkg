...
class ModelAccountCustomer extends Model {
	public function addCustomer($data) {
		...
		$customer_id = $this->db->getLastId();
      	...
      	$this->db->query("INSERT INTO " . DB_PREFIX . "address SET customer_id = '" . (int)$customer_id . "', firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "', company = '" . $this->db->escape($data['company']) . "', company_id = '" . $this->db->escape($data['company_id']) . "', tax_id = '" . $this->db->escape($data['tax_id']) . "', batiment = '" . $this->db->escape($data['batiment']) . "', escalier = '" . $this->db->escape($data['escalier']) ."', interphone = '" . $this->db->escape($data['interphone']) . "', ascenceur = '" . $this->db->escape($data['ascenceur']) . "', digicode1 = '" . $this->db->escape($data['digicode1']) . "', digicode2 = '" . $this->db->escape($data['digicode2']) . "', etage = '" . $this->db->escape($data['etage']) . "', porte = '" . $this->db->escape($data['porte']) .  "', address_1 = '" . $this->db->escape($data['address_1']) . "', address_2 = '" . $this->db->escape($data['address_2']) . "', city = '" . $this->db->escape($data['city']) . "', postcode = '" . $this->db->escape($data['postcode']) . "', country_id = '" . (int)$data['country_id'] . "', zone_id = '" . (int)$data['zone_id'] . "'");
