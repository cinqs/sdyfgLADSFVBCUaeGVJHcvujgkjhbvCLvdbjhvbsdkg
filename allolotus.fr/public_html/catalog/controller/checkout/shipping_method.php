...
class ControllerCheckoutShippingMethod extends Controller {
	...
	public function setEmporter(){
		if (isset($this->request->post['isEmporter'])) {
			$this->session->data['isEmporter'] = $this->request->post['isEmporter'];
		}

		print isset($this->session->data['isEmporter']);
	}

	public function getEmporterStatus(){
		if (isset($this->session->data['isEmporter'])) {
			print $this->session->data['isEmporter'];
		}else{
			print 0;
		}
	}
