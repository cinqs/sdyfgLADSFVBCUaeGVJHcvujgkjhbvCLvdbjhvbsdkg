...
class ControllerCheckoutCart extends Controller {
	...
	public function add_bak(){
		...
		$this->cart->add($this->request->post['product_id'], $quantity, $meal);


		print json_encode($meal);
	}					
	public function add() {
		$this->language->load('checkout/cart');
		...
		//if($this->request->post['meal'] != 'undefined'){
	...
	public function couvUpdate(){
		$couvQuantity = intval($this->request->post['couvQuantity']) >= 0 ? $this->request->post['couvQuantity'] : 0;

		$this->session->data['couv'] = $couvQuantity;
	}

	public function couvGet(){
		if (isset($this->session->data['couv'])) {
			$couvQuantity = $this->session->data['couv'];
		}else{
			$couvQuantity = 0;
		}
