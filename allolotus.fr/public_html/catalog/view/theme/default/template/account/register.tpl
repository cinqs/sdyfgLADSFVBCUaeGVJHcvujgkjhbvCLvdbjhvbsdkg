	...
	<div class="content">
		...
		<div class="row">
			...
			<div class="col-md-8"><!--
				...
				<select class='form-control' type="text" name="postcode" id="postalcode">
			...
			<div style="display: none;">
				...
				<input class="form-control" type="text" name="company_id"value="">
				<input class="form-control" type="text" name="tax_id" value="">
			</div>
			<script type="text/javascript">
				$(document).ready(function(){
					$.ajax({
						url: 'index.php?route=checkout/checkout/country&country_id=73',
						dataType:'json',
						beforeSend: function() {
