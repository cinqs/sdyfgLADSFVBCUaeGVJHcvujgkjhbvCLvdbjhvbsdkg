  ...
  <?php if ($deviceUse == "desktop") {?>
      ...
      <div class="nousMain container">
        <div class="nousLeft wow animated fadeInLeft">
          <div class="left-top">
            <h3 class="color_spe font30px"><?php echo $store_name?></h3>
            <h4 class="color-black font18px"><?php echo $telephone?></h4>
            <p class="color-yellow font12px bottom_border"><a target="_blank" href="https://www.google.fr/maps/place/<?php echo $address;?>"><?php echo $address;?></a></p>
          </div>
        ...
        <div class="nousRight"><!--
          ...
          <div class="content wow animated fadeInRight">
            ...
            <div class="box1 color-gray ">
              <h4 class="color-yellow ">Paris 10ème 18ème 19ème</h4>
              <h5 >Livraison  gratuite à partir de <span style="color:#ba1d27">15€</span></h5>
              <h4 class="color-yellow ">Paris 2ème 3ème 9ème</h4>
              <h5 >Livraison  gratuite à partir de <span style="color:#ba1d27">20€</span></h5>
              <h4 class="color-yellow ">Paris 1ème 4ème 11ème</h4>
              <h5 >Livraison  gratuite à partir de <span style="color:#ba1d27">30€</span></h5>
            </div>
            <div class="box2">
              <p class="p1">
                <span class="lb">- À Partir de 25€</span>
                <span>Un dessert ou boisson offerte</span>
              </p>
              <p class="p1">
                <span class="lb">- À Partir de 35€</span>
                <span>Une bière offerte</span>
              </p>
              <p class="p1">
                <span class="lb">- À Partir de 45€</span>
                <span>Un bôite de lychees offerte</span>
              </p>
            </div>
