...
<body>
		...
		<section class="index-container">
			...
			<?php if ($deviceUse == "desktop") {?>
			    <div id="myCarousel" class="carousel slide" data-ride="carousel">
			      ...
			      <div class="carousel-inner" role="listbox">
			        <div class="item active" style="background-image: url(image/front/homebg1.jpg)"></div>
			        <div class="item" style="background-image: url(image/front/homebg2.jpg)"></div>
			        <div class="item" style="background-image: url(image/front/homebg3.jpg)"></div>
			        <div class="item" style="background-image: url(image/front/homebg4.jpg)"></div>
			      </div>
			...
			<?php }elseif ($deviceUse == "mobile") {?>
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
			      ...
			      <div class="carousel-inner" role="listbox">
			        <div class="item active" style="background-image: url(image/mobile/lotus3.jpg)"></div>
			        <div class="item" style="background-image: url(image/mobile/lotus4.jpg)"></div>
			      </div>
			      <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev">
			        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
			        <span class="sr-only">Previous</span>
	...
	<div class="fixedCorner topCor" id="tl"></div>
	<div class="fixedCorner topCor" id="tr"></div>
	<div class="fixedCorner" id="bl"></div>
	<div class="fixedCorner" id="br"></div>
	<script type="text/javascript">
		$(".topCor").css({
			"top":$(".navbar").height(),
		});
