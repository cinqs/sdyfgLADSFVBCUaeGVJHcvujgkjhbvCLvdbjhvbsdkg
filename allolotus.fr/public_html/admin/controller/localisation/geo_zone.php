...
class ControllerLocalisationGeoZone extends Controller { 
	...
	protected function getList() {
		...
		$this->data['column_limite'] = $this->language->get('column_limite');//New
		...
		$this->data['sort_limite'] = $this->url->link('localisation/geo_zone', 'token=' . $this->session->data['token'] . '&sort=limite' . $url, 'SSL');//New
	...
	protected function getForm() {
		...
		$this->data['entry_limite'] = $this->language->get('entry_limite');//New
...
//New
 		if (isset($this->error['limite'])) {
			$this->data['error_limite'] = $this->error['limite'];
		} else {
			$this->data['error_limite'] = '';
		}
...
//New
		if (isset($this->request->post['limite'])) {
			$this->data['limite'] = $this->request->post['limite'];
		} elseif (!empty($geo_zone_info)) {
			$this->data['limite'] = $geo_zone_info['limite'];
		} else {
			$this->data['limite'] = '';
		}
...
//New
		if ((utf8_strlen($this->request->post['limite']) < 1) || (utf8_strlen($this->request->post['limite']) > 32)) {
			$this->error['limite'] = $this->language->get('error_limite');
		}
