...
<head><title>Lotus AutoPrint</title>
      ...
      $.ajax({
        ...
        success: function(dataGet){
          ...
          if (dataGet != null) {
            ...
            var lastest_order_content = '<table>';
            for(var i = 0; i < orderTrans[1].length; i++){
              ...
              lastest_order_content +="<tr><td>"+orderTrans[1][i].quantity +" X " + orderTrans[1][i].name+"</td><td><span class='order_detail_total'>"+parseFloat(orderTrans[1][i].total) + "</span></td></tr>"
            }
            lastest_order_content +="</table>"
