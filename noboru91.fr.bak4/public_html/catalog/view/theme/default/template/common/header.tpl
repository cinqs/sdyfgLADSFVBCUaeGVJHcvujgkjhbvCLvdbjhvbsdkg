						...
						<div class="total-list-box">
								...
								<table class='cart_class'>
									...
									<tr class="tr_special">
										...
										<td></td>
										<td>
											<span class="minusCart" name="633" value="<?=$p_de_bagu_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
											<span><?=$p_de_bagu_qty?></span>&nbsp;&nbsp;
											<span class="plusCart" name="633" value="<?=$p_de_bagu_qty?>"><i class="fa fa-plus"></i></span>
										</td>
										<td><div class="delete_cart_menu" name="633"><i class="fa fa-trash-o"></i></div></td>
									</tr>
									<tr class="tr_special">
										<td>Sauce Sucre</td>
										<td></td>
										<td>
											<span class="minusCart" name="634" value="<?=$sucre_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
											<span><?=$sucre_qty?></span>&nbsp;&nbsp;
											<span class="plusCart" name="634" value="<?=$sucre_qty?>"><i class="fa fa-plus"></i></span>
										</td>
										<td><div class="delete_cart_menu" name="634"><i class="fa fa-trash-o"></i></div></td>
									</tr>
									<tr class="tr_special">
										<td>Sauce Sale</td>
										<td></td>
										<td>
											<span class="minusCart" name="635" value="<?=$sale_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
											<span><?=$sale_qty?></span>&nbsp;&nbsp;
											<span class="plusCart" name="635" value="<?=$sale_qty?>"><i class="fa fa-plus"></i></span>
										</td>
										<td><div class="delete_cart_menu" name="635"><i class="fa fa-trash-o"></i></div></td>
									</tr>
									...
									<tr class="tr_special">
										...
										<td><div class="delete_cart_menu" name="241"><i class="fa fa-trash-o"></i></div></td>
									</tr>
									<tr class="tr_special">
										<td>Wasabi</td>
										<td></td>
										<td>
											<span class="minusCart" name="242" value="<?=$wasabi_qty?>"><i class="fa fa-minus"></i></span>&nbsp;&nbsp;
											<span><?=$wasabi_qty?></span>&nbsp;&nbsp;
											<span class="plusCart" name="242" value="<?=$wasabi_qty?>"><i class="fa fa-plus"></i></span>
										</td>
										<td><div class="delete_cart_menu" name="242"><i class="fa fa-trash-o"></i></div></td>
									</tr>
									<tr>
