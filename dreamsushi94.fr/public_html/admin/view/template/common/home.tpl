        ...
        <div class="box span12">
          ...
          <div class="box-content">
            ...
            <p class="center">
              ...
              <a target="_blank" class="btn btn-large btn-primary" id="autoprintButton"><i class="icon-chevron-left icon-white"></i> Autoprint</a>
              <form action="sample.php" method="POST" id="goToAutoprint">
                <input type="hidden" name="token" value="<?php echo $token; ?>">
              </form>
              <script type="text/javascript">
              $("#autoprintButton").click(function(){
                $("#goToAutoprint").submit();
              });
              </script>
