<?php echo $header; ?>
			<script type="text/javascript">
				<?php if (isset($_SESSION["mailNotSent"]) && ($_SESSION["mailNotSent"] != "unset")) {?>
					alert("problème détecté, réessayer plus tard s'il vous plaît ");
				<?php $_SESSION["mailNotSent"] = "unset";};?>
				<?php if (isset($_SESSION["mailSent"]) && ($_SESSION["mailSent"] != "unset")) {?>
					alert("mail envoyé à <?=$_SESSION['mailSent']?>");
				<?php $_SESSION["mailSent"] = "unset";};?>
			</script>
