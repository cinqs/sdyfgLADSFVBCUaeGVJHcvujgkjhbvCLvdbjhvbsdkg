...
<head>
	...
	<link rel="stylesheet" href="http://dreamsushi94.fr/catalog/view/theme/default/stylesheet/new/grid.css">
	...
	<script src="http://dreamsushi94.fr/catalog/view/theme/default/new-js/new/customer.js"></script>
			...
			<div class="container">
				<div class="row" id="cate_row_restr_width">
					<div class="carteLeft font14 col-md-4"><!--
						...
						<form action="http://dreamsushi94.fr/index.php?route=checkout/cart" method="post" enctype="multipart/form-data" id="cart_form">
						<h3 class="tb-icon"><a href="http://dreamsushi94.fr/index.php?route=checkout/cart"> MON PANIER </a></h3>
