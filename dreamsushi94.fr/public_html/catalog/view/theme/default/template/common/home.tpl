		...
		<section class="index-container">
		    ...
		    <?php if ($deviceUse == "desktop") {?>
			    <div id="myCarousel" class="carousel slide" data-ride="carousel">
			      ...
			      <div class="carousel-inner" role="listbox">
			        <div class="item active" style="background-image: url(image/new/dreamweb1.png)"></div>
			        <div class="item" style="background-image: url(image/new/dreamweb2.png)"></div>
			        <div class="item" style="background-image: url(image/new/dreamweb3.png)"></div>
			      </div>
			...
			<?php }elseif ($deviceUse == "mobile") {?>
				<div id="myCarousel" class="carousel slide" data-ride="carousel">
			      ...
			      <div class="carousel-inner" role="listbox">
			        <div class="item active" style="background-image: url(image/dreamphone.jpg)"></div>
			      </div>
			      <a class="left carousel-control" href="#myCarousel" role="button" data-slide="prev">
			        <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>
			        <span class="sr-only">Previous</span>
