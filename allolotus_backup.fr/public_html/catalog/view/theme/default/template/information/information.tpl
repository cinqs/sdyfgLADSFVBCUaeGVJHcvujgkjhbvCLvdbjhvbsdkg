      ...
      <div class="nousMain container">
        ...
        <div class="nousRight"><!--
          ...
          <div class="content wow animated fadeInRight">
            ...
            <div class="">
            <iframe width="600" height="450" frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?q=<?php echo str_ireplace(" ", "%20", $address);?>&key=AIzaSyDAxUUqgcP65yf9D5R8Lq_pJU66XRK2Lsc" allowfullscreen></iframe>
            </div>
