...
/* 修改 'sort_order'  => $result['sort_order'], */
$this->load->model('catalog/category');
$category_info = $this->model_catalog_category->getCategory($result['category_id']);
	...
	protected function getForm() {
		...
		$this->data['entry_meal'] =$this->language->get('entry_meal');
		$this->data['entry_column'] = $this->language->get('entry_column');		
		$this->data['entry_sort_order'] = $this->language->get('entry_sort_order');
		$this->data['entry_temp'] = $this->language->get('entry_temp'); //New
		...
		if (isset($this->request->post['meal'])) {
			$this->data['meal'] = $this->request->post['meal'];
		} elseif (!empty($category_info)) {
		...
		if (isset($this->request->post['temp'])) {
			$this->data['temp'] = $this->request->post['temp'];
		} elseif (!empty($category_info)) {
			$this->data['temp'] = $category_info['temp'];
		} else {
			$this->data['temp'] = 0;
