...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$this->data['entry_bienvenue_credit'] = $this->language->get('entry_bienvenue_credit');	
		$this->data['entry_horaire_AM'] = $this->language->get('entry_horaire_AM');
		$this->data['entry_horaire_PM'] = $this->language->get('entry_horaire_PM');
		...
		if (isset($this->request->post['config_name'])) {
			...
			$this->data['config_title'] = $this->request->post['config_name'];
		} else {
		...
		if (isset($this->request->post['config_bienvenue_credit'])) {
			$this->data['config_bienvenue_credit'] = $this->request->post['config_bienvenue_credit'];
		} else {
			$this->data['config_bienvenue_credit'] = $this->config->get('config_bienvenue_credit');
		}

		if (isset($this->request->post['config_horaire_AM_1'])) {
			$this->data['config_horaire_AM_1'] = $this->request->post['config_horaire_AM_1'];
		} else {
			$this->data['config_horaire_AM_1'] = $this->config->get('config_horaire_AM_1');
		}

		if (isset($this->request->post['config_horaire_PM_1'])) {
			$this->data['config_horaire_PM_1'] = $this->request->post['config_horaire_PM_1'];
		} else {
			$this->data['config_horaire_PM_1'] = $this->config->get('config_horaire_PM_1');
		}

		if (isset($this->request->post['config_horaire_AM_2'])) {
			$this->data['config_horaire_AM_2'] = $this->request->post['config_horaire_AM_2'];
		} else {
			$this->data['config_horaire_AM_2'] = $this->config->get('config_horaire_AM_2');
		}

		if (isset($this->request->post['config_horaire_PM_2'])) {
			$this->data['config_horaire_PM_2'] = $this->request->post['config_horaire_PM_2'];
		} else {
			$this->data['config_horaire_PM_2'] = $this->config->get('config_horaire_PM_2');
		}

		if (isset($this->request->post['config_horaire_AM_3'])) {
			$this->data['config_horaire_AM_3'] = $this->request->post['config_horaire_AM_3'];
		} else {
			$this->data['config_horaire_AM_3'] = $this->config->get('config_horaire_AM_3');
		}

		if (isset($this->request->post['config_horaire_PM_3'])) {
			$this->data['config_horaire_PM_3'] = $this->request->post['config_horaire_PM_3'];
		} else {
			$this->data['config_horaire_PM_3'] = $this->config->get('config_horaire_PM_3');
		}

		if (isset($this->request->post['config_horaire_AM_4'])) {
			$this->data['config_horaire_AM_4'] = $this->request->post['config_horaire_AM_4'];
		} else {
			$this->data['config_horaire_AM_4'] = $this->config->get('config_horaire_AM_4');
		}

		if (isset($this->request->post['config_horaire_PM_4'])) {
			$this->data['config_horaire_PM_4'] = $this->request->post['config_horaire_PM_4'];
		} else {
			$this->data['config_horaire_PM_4'] = $this->config->get('config_horaire_PM_4');
		}

		if (isset($this->request->post['config_horaire_AM_5'])) {
			$this->data['config_horaire_AM_5'] = $this->request->post['config_horaire_AM_5'];
		} else {
			$this->data['config_horaire_AM_5'] = $this->config->get('config_horaire_AM_5');
		}

		if (isset($this->request->post['config_horaire_PM_5'])) {
			$this->data['config_horaire_PM_5'] = $this->request->post['config_horaire_PM_5'];
		} else {
			$this->data['config_horaire_PM_5'] = $this->config->get('config_horaire_PM_5');
		}

		if (isset($this->request->post['config_horaire_AM_6'])) {
			$this->data['config_horaire_AM_6'] = $this->request->post['config_horaire_AM_6'];
		} else {
			$this->data['config_horaire_AM_6'] = $this->config->get('config_horaire_AM_6');
		}

		if (isset($this->request->post['config_horaire_PM_6'])) {
			$this->data['config_horaire_PM_6'] = $this->request->post['config_horaire_PM_6'];
		} else {
			$this->data['config_horaire_PM_6'] = $this->config->get('config_horaire_PM_6');
		}

		if (isset($this->request->post['config_horaire_AM_0'])) {
			$this->data['config_horaire_AM_0'] = $this->request->post['config_horaire_AM_0'];
		} else {
			$this->data['config_horaire_AM_0'] = $this->config->get('config_horaire_AM_0');
		}

		if (isset($this->request->post['config_horaire_PM_0'])) {
			$this->data['config_horaire_PM_0'] = $this->request->post['config_horaire_PM_0'];
		} else {
			$this->data['config_horaire_PM_0'] = $this->config->get('config_horaire_PM_0');
		}

		if (isset($this->request->post['config_text_maintenance'])) {
			$this->data['config_text_maintenance'] = $this->request->post['config_text_maintenance'];
		} else {
			$this->data['config_text_maintenance'] = $this->config->get('config_text_maintenance');
		}
		...
		if (isset($this->request->post['config_name'])) {
			...
			$this->data['config_title'] = $this->config->get('config_name');
		}
		...
		if (isset($this->request->post['config_promotion_1'])) {
			$this->data['config_promotion_1'] = $this->request->post['config_promotion_1'];
		} else {
			$this->data['config_promotion_1'] = $this->config->get('config_promotion_1');
		}
		if (isset($this->request->post['config_promotion_2'])) {
			$this->data['config_promotion_2'] = $this->request->post['config_promotion_2'];
		} else {
			$this->data['config_promotion_2'] = $this->config->get('config_promotion_2');
		}
		if (isset($this->request->post['config_promotion_3'])) {
			$this->data['config_promotion_3'] = $this->request->post['config_promotion_3'];
		} else {
			$this->data['config_promotion_3'] = $this->config->get('config_promotion_3');
		}
		if (isset($this->request->post['config_money_1'])) {
			$this->data['config_money_1'] = $this->request->post['config_money_1'];
		} else {
			$this->data['config_money_1'] = $this->config->get('config_money_1');
		}
		if (isset($this->request->post['config_money_2'])) {
			$this->data['config_money_2'] = $this->request->post['config_money_2'];
		} else {
			$this->data['config_money_2'] = $this->config->get('config_money_2');
		}
		if (isset($this->request->post['config_money_3'])) {
			$this->data['config_money_3'] = $this->request->post['config_money_3'];
		} else {
			$this->data['config_money_3'] = $this->config->get('config_money_3');
		}
