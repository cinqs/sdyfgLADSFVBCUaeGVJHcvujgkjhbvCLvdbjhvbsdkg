...
<script type="text/javascript"><!--
setTimeout("self.location.reload();",18000);
//--></script>
  ...
  <div class="box">
    ...
    <div>
      <table class="form">
        <tbody><tr>
          <td class="newreport_filtre">Date commence:            <input  name="filter_date_start" value="<?php echo $filter_date_start; ?>" id="date-start" size="12" type="text"></td>
          <td class="newreport_filtre">Date fin:            <input  name="filter_date_end" value="<?php echo $filter_date_end; ?>" id="date-end" size="12" type="text"></td>
          <td class="newreport_filtre">Commande Statut:            <select name="filter_order_status_id">
              <option selected="selected" value="0">Tous statuts</option>
         ...
         <?php if ($customers) { ?>
          <?php foreach ($customers as $customer) { ?>
            ...
            <td class="left"><?php echo $customer['date_added']; ?></td>
                        <td class="left" style="font-size:14px;color:blue" id="<?php echo $customer['status']; ?>"><?php echo $customer['status']; ?>                  </td><td class="left"><?php echo $customer['customer']; ?></td>
            <td class="left"><?php echo $customer['customer']; ?></td>
            ...
            <td class="left"><a href="http://maps.google.com/maps?daddr=<?php echo $customer['address']; ?>,<?php echo $customer['postcode']; ?>&saddr=60 boulevard de verdun92400 COURBEVOIE" target="_BLANK"><img src="view/image/gmaps.png" alt=""></a></td>
