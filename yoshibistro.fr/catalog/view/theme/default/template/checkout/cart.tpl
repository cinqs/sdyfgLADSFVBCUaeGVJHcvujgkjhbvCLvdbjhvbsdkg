...
<?php } ?>
				...
				<div id="main_content" class="col-sm-9">
					...
					<div class="cart-scope">
						...
						<div class="page_header">
						  <h1 class="page_heading"><?php echo $heading_title; ?>
						  </h1>
						</div>
										...
										<div class="col-lg-9 col-md-9 col-sm-9">
											...
											<div class="item_price">
												<div class="row">
													...
													<div class="col-sm-8">
														<div class="qty">
															<label for="quantity[<?php echo $product['key']; ?>]">
  ...
  <?php } ?>
								...
								<?php if ($total_money < 16) {?>
									<div class="cart_buttons">
										<p style="color:red;font-weight:700">Livraison gratuite à partir de 16€ </p>
								...
								<a href="<?php echo $continue; ?>"><?php echo $button_shopping; ?></a>
									...
									<a id="aa" href="<?php echo $checkout; ?>" value="Check out" class="btn btn-primary" type="submit"><?php echo $button_checkout; ?></a>
								</div>
									<?php }?>
